...
| p.84 下から3行目 | `prediction_layer = tf.keras.layers.Dense(NUM_CLASSES)` | `prediction_layer = tf.keras.layers.Dense(NUM_CLASSES, activation='softmax')` | [#26](https://github.com/karaage0703/karaage-ai-book/issues/26) |
